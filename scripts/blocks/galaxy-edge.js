...
var pullscales = [/*edge*/1, 1.02, 1.04, /*2*/1.06, 1.073, 1.086, /*3*/1.1, 1.113, 1.126, /*mid*/1.14];
//Determines how far each section of the end should extend past the main thickest section
var lenscales = [/*edge*/1, 1.053, 1.106, /*2*/1.16, 1.2, 1.24,/*3*/1.28, 1.32, 1.36, /*mid*/1.4];
